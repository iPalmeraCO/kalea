...
class Order extends AbstractModel implements EntityInterface, OrderInterface
{
    ...
    /* Set ncuotas */
    public function setNcuotas($cuotas)
    {
        return $this->setData('ncuotas', $cuotas);
    }

    /*Get ncuotas */
    public function getNcuotas()
    {
        return $this->getData('ncuotas');
    }

    /*Valor cuotas*/
      public function setVcuotas($vcuotas)
    {
        return $this->setData('vcuotas', $vcuotas);
    }

    /*Get vCuotas */
    public function getVcuotas()
    {
        return $this->getData('vcuotas');
    }

        /*Valor cedula*/
      public function setCedula($cedula)
    {
        return $this->setData('cedula', $cedula);
    }

    /*Get cedula */
    public function getCedula()
    {
        return $this->getData('cedula');
    }
