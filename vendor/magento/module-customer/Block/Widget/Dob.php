...
class Dob extends AbstractWidget
{
    ...
    public function getFieldHtml()
    {
        ...
        $nuevafecha = strtotime ( '-100 year' , strtotime ( $fecha ) ) ;
        $nuevafecha = date ( 'Y' , $nuevafecha );

        $nuevafecha2 = strtotime ( '-14 year' , strtotime ( $fecha ) ) ;
        $nuevafecha2 = date ( 'Y' , $nuevafecha2 );
        ...
        $this->dateElement->setData([
            ...
            'name' => $this->getHtmlId(),
            'id' => $this->getHtmlId(),            
            'class' => $this->getHtmlClass()." requiredkalea",
            'value' => $value,
            'date_format' => $this->getDateFormat(),
            'image' => $this->getViewFileUrl('Magento_Theme::calendar.png'),            
            'years_range' => $nuevafecha.':'.$nuevafecha2,            
            'change_month' => 'true',
            'change_year' => 'true',
            'show_on' => 'both',            
    ...
    public function getHtmlExtraParams()
    {
        ...
        return 'data-validate="' . $this->_escaper->escapeHtml(json_encode($validators)) . '" placeholder="Fecha de nacimiento*"';
    }
